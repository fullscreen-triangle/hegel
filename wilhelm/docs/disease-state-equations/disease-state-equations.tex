...
% Title
\title{Disease State Equations: Mathematical Principles of Pathological Dynamics in Bounded Phase Space}
\author{}
\date{}
...
\input{sections/categorical-differential-equations}
\input{sections/categorical-memory-reset}
\input{sections/pathological-equations-of-state}
\input{sections/disease-categories}
\input{sections/immune-equations-of-state}
\input{sections/therapeutic-equations-of-state}
\input{sections/phase-coherence}
